...
void LPSPI_MasterGetDefaultConfig(lpspi_master_config_t *masterConfig)
{
	...
	masterConfig->cpol = kLPSPI_ClockPolarityActiveHigh;       //when idle clock is low
	masterConfig->cpha = kLPSPI_ClockPhaseFirstEdge;           //data is sampled on first clock edge
